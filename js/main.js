...
function solution1() {
    fetch('/data_transform/teams_scores.json')
...
function solution2(){
    fetch('/data_transform/rcb_batsmen_runs.json')
    .then((response)=>{return response.json()})
    .then((data) => {
...
function solution3() {
    fetch('/data_transform/country_umpire_count.json')
    .then((response)=>{return response.json()})
    .then((data) => {
...
function solution4(){
    fetch('/data_transform/all_seasons.json')
    .then((response) => {return response.json()})
    .then((data) => {
